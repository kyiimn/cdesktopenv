...
struct rpcgen_table tableprog_5_table[] = {
	...
	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_ping_5_svc),
	(xdrproc_t)xdr_void,			0,
	(xdrproc_t)xdr_void,			0,

	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_list_calendars_5_svc),
	(xdrproc_t)xdr_void,			0,
	(xdrproc_t)xdr_cms_list_calendars_res,	sizeof ( cms_list_calendars_res ),

	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_open_calendar_5_svc),
	(xdrproc_t)xdr_cms_open_args,		sizeof ( cms_open_args ),
	(xdrproc_t)xdr_cms_open_res,		sizeof ( cms_open_res ),

	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_create_calendar_5_svc),
	(xdrproc_t)xdr_cms_create_args,		sizeof ( cms_create_args ),
	(xdrproc_t)xdr_u_int,		sizeof ( u_int ),

	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_remove_calendar_5_svc),
	(xdrproc_t)xdr_cms_remove_args,		sizeof ( cms_remove_args ),
	(xdrproc_t)xdr_u_int,		sizeof ( u_int ),

	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_register_5_svc),
	(xdrproc_t)xdr_cms_register_args,		sizeof ( cms_register_args ),
	(xdrproc_t)xdr_u_int,		sizeof ( u_int ),

	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_unregister_5_svc),
	(xdrproc_t)xdr_cms_register_args,		sizeof ( cms_register_args ),
	(xdrproc_t)xdr_u_int,		sizeof ( u_int ),

	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_enumerate_calendar_attr_5_svc),
	...
	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_get_calendar_attr_5_svc),
	...
	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_insert_entry_5_svc),
	(xdrproc_t)xdr_cms_insert_args,		sizeof ( cms_insert_args ),
	(xdrproc_t)xdr_cms_entry_res,		sizeof ( cms_entry_res ),

	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_update_entry_5_svc),
	(xdrproc_t)xdr_cms_update_args,		sizeof ( cms_update_args ),
	(xdrproc_t)xdr_cms_entry_res,		sizeof ( cms_entry_res ),

	(char *(*)(void *, struct svc_req *)) RPCGEN_ACTION(cms_delete_entry_5_svc),
